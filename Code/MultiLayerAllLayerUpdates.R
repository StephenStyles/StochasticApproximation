...
bias1 = t(read.table("final12firstlayerint2layer.csv",sep = ","))
weights1 = read.table("final12firstlayercoef2layer.csv",sep = ",")
w1df = rbind(bias1, weights1)
w1 = as.numeric(c(w1df[1,],w1df[2,],w1df[3,],w1df[4,],w1df[5,]))


bias2 = t(read.table("final12secondlayerint2layer.csv",sep = ","))
weights2 = read.table("final12secondlayercoef2layer.csv",sep = ",")
...
bias3 = t(read.table("final12thirdlayerint2layer.csv",sep = ","))
weights3 = read.table("final12thirdlayercoef2layer.csv",sep = ",")
w3df = rbind(bias3, weights3)
w3 = as.numeric(c(w3df[1,],w3df[2,],w3df[3,],w3df[4,],w3df[5,],
                  w3df[6,],w3df[7,],w3df[8,],w3df[9,],w3df[10,],
                  w3df[11,],w3df[12,],w3df[13,],w3df[14,],w3df[15,],
                  w3df[16,],w3df[17,],w3df[18,],w3df[19,],w3df[20,],
                  w3df[21,]))
...
for(k in 1:10){
  ...
  for(i in 1:n){
    ...
    X2 = cbind(1*diag(20),x2[1]*diag(20),x2[2]*diag(20),x2[3]*diag(20),x2[4]*diag(20),
               x2[5]*diag(20),x2[6]*diag(20),x2[7]*diag(20),x2[8]*diag(20),
               x2[9]*diag(20),x2[10]*diag(20),x2[11]*diag(20),x2[12]*diag(20),
               x2[13]*diag(20),x2[14]*diag(20),x2[15]*diag(20),x2[16]*diag(20),
               x2[17]*diag(20),x2[18]*diag(20),x2[19]*diag(20),x2[20]*diag(20))
    ...
    w1 = w1 + (1/10)*(B1check-A1check%*%w1)
    w2 = w2 + (1/20)*(B2check-A2check%*%w2)
